    ...
    () =>
      createTheme({
        ...
        typography: {
          ...
          h1: { fontWeight: 800, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.04em' },
          h2: { fontWeight: 800, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.03em' },
          h3: { fontWeight: 800, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.02em' },
          h4: { fontWeight: 700, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.02em' },
          h5: { fontWeight: 700, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.01em' },
          h6: { fontWeight: 700, color: mode === 'light' ? '#1F1F1F' : '#fff', letterSpacing: '-0.01em' },
